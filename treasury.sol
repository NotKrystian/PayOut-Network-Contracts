...
contract Pay0utTreasury is Ownable, VaultOwned, BondOwned {
    using SafeMath for uint256;
    using Address for address;
    ...
    function setPayoutToken(address value) public onlyOwner() {
        payoutToken = value;
    }

    function setStakedPayoutToken(address value) public onlyOwner() {
        stakedPayoutToken = value;
    }
